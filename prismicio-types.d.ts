 ...
 */
export interface AlternationTextSliceDefaultPrimaryTextGroupItem {
  /**
   * Heading field in *AlternatingText → Default → Primary → Text Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: alternation_text.default.primary.text_group[].heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: alternation_text.default.primary.text_group[].body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
 ...
 */
export interface AlternationTextSliceDefaultPrimary {
  /**
   * Text Group field in *AlternatingText → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: alternation_text.default.primary.text_group[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  text_group: prismic.GroupField<
    Simplify<AlternationTextSliceDefaultPrimaryTextGroupItem>
  >;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AlternationTextSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<AlternationTextSliceDefaultPrimary>,
  never
>;
 ...
 */
type AlternationTextSliceVariation = AlternationTextSliceDefault;

/**
 * AlternatingText Shared Slice
 *
 * - **API ID**: `alternation_text`
 * - **Description**: AlternationText
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AlternationTextSlice = prismic.SharedSlice<
  "alternation_text",
  AlternationTextSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      AlternationTextSlice,
      AlternationTextSliceDefaultPrimaryTextGroupItem,
      AlternationTextSliceDefaultPrimary,
      AlternationTextSliceVariation,
      AlternationTextSliceDefault,
      BigtextSlice,
      BigtextSliceVariation,
      BigtextSliceDefault,
      CarouselSlice,
