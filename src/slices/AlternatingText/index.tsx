...
export type AlternationTextProps =
  SliceComponentProps<Content.AlternationTextSlice>;
 
const AlternationText: FC<AlternationTextProps> = ({ slice }) => {
...
export default AlternationText;
